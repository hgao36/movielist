...
const MovieCard = props => {
    ...
    return (
        <div className='moviecard'>
            ...
            <span className='vote_average'>vote_average:{props.vote_average}____</span>
            <span className='vote_count'>vote_count:{props.vote_count}</span>
            <br />
            <button className='like' onClick={props.handleLike}>like</button>
            <button className='block' onClick={props.handleBlock}>block</button>
